...
public record BarkItemRenderer() implements SpecialModelRenderer<BarkTypeConfig.BarkTypeEntry> {
    ...
    @Override
    public void submit(BarkTypeConfig.@Nullable BarkTypeEntry barkTypeEntry, ItemDisplayContext itemDisplayContext, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, int overlayCoords, boolean hasFoil, int outlineColor) {
